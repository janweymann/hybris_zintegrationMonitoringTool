 ...
 */
public class ZintegrationtoolManager extends GeneratedZintegrationtoolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ZintegrationtoolManager.class.getName());
	 ...
	 */
	public static ZintegrationtoolManager getInstance()
	{
		return (ZintegrationtoolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ZintegrationtoolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ZintegrationtoolManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ZintegrationtoolManager called.");
		}
	}
